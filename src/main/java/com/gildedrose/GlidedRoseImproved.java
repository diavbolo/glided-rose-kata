...
/**
 * The GlidedRoseImproved class, defined as a child of GildedRose, implements
 * the handling of diverse items regarding the expiration and the quality.
 *
 * @author diavbolo
 * @version 1.0
 */
public class GlidedRoseImproved extends GildedRose {
	...
	/**
	 * Function that updates the items quality based on its name. First adjust the
	 * quality and then the sellIn since the later is a condition to adjust the
	 * former.
	 */
	@Override
	...
	/**
	 * Function that decreases the quality of an item by one except when expired
	 * when it will be by two.
	 */
	...
	/**
	 * Function that decreases the quality of an item based on a value but without
	 * becoming negative.
	 * 
	 * @param value
	 */
	...
	/**
	 * Function that increases the quality of an item based on a value up to
	 * MAXQUALITY.
	 * 
	 * @param value
	 */
